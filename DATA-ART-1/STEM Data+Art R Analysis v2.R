...
#Make wordcloud
wordcloud2(careerGirl, size=1.5,  color=rep_len(pinkPalette, nrow(careerGirl) ))
wordcloud2(careerBoy,  size=1, color=rep_len( bluePalette, nrow(careerBoy) ))
...
wordcloud2(hobbiesGirl, size=1.5, figPath = imgGirl, color=rep_len( pinkPalette, nrow(career) ) )
wordcloud2(hobbiesBoy, size=3, figPath = imgBoy, color=rep_len( bluePalette, nrow(career) ) )
...
wordcloud2(selfBoy, size=3, figPath = heartimg, color=rep_len( bluePalette, nrow(selfBoy) ) )
wordcloud2(selfGirl, size=1.5, figPath = heartimg, color=rep_len( pinkPalette, nrow(selfGirl) ) )

# Self bar charts
selfGirl$gender <- 'female'
selfBoy$gender <- 'male'
fullSelf <-rbind(hobbiesBoy, hobbiesGirl)
fullSelf
